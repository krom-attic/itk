 ...
 *
 * http://myjavafx.blogspot.ru/2012/03/treeview-with-data-source.html
 */
public class TreeViewWithItems<T extends IHierarchicalData<T>> extends TreeView<T> {
    ...
    private void clear(TreeItem<T> root) {
        if (root != null) {
            root.getChildren().forEach(this::removeRecursively);
